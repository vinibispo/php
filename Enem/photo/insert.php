...
<?php
    ...
    if(isset($_POST['include'])){
        ...
        $sql = "INSERT questoes INTO (id,enunciado,imagem,alternativaA,alternativaB, alternativaC, alternativaD, alternativaE, alternativaCorreta) VALUES('$id','$enunciado','$novonome','$a','$b', '$c', '$d', '$e','$ac' WHERE id=$id";
...
<body>
    <form method="post"  enctype="multipart/form-data">
        <textarea name="enunciado" placeholder="Enunciado"></textarea>
        ...
        <button type="submit" name="include">Atualizar</button>
    </form>
